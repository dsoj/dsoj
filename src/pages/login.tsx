                        ...
                        <div className="card mb-5">
                            <div className="card-body d-flex flex-column align-items-center">
                                ...
                                <form className="text-center" method="post">
                                    ...
                                    <p style={{ borderTop: "1px solid var(--bs-body-color)", marginBottom: "0.5rem", paddingTop: "1rem" }}>Wanna start a new journey with DSOJ?</p><button className="btn btn-primary d-block w-100" type="submit" style={{ background: "#4CAF50", border: 0 }}>Sign up</button>
                                </form>
                            </div>
                        </div>
                    </div>
